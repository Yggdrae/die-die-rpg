...
| 02 | [SQLite worker, OPFS persistence, and fallback](tasks/task_02.md) | — | completed |
| 03 | [Durable mutation queue and SyncedRepository](tasks/task_03.md) | 02 | completed |
| 04 | [PowerSync read path and authorized upload endpoint](tasks/task_04.md) | 01, 03 | pending |
| 05 | [Deferred conflicts and semantic operations](tasks/task_05.md) | 03–04 | completed |
| 06 | [Single-writer long-text holds](tasks/task_06.md) | 03–04 | completed |
