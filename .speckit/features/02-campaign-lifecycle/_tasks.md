...
| --- | --- | --- | --- |
| 01 | [Public campaign contracts and manifest-driven rules](tasks/task_01.md) | feature 08 contract or approved fixture | pending |
| 02 | [Campaign PostgreSQL schema and owner invariant](tasks/task_02.md) | 01, feature 01 membership schema | pending |
| 03 | [Campaign application services and context resolver](tasks/task_03.md) | 01, 02 | pending |
| 04 | [Fastify campaign API](tasks/task_04.md) | 03, feature 04 decision API | pending |
| 05 | [Creation wizard and campaign list](tasks/task_05.md) | 01, 04 | pending |
| 06 | [Offline creation and synchronized campaign repository](tasks/task_06.md) | 03, feature 03 repository | pending |
| 07 | [Explicit system-version update flow](tasks/task_07.md) | 03, 04, feature 08 exact-version resolver | pending |
